...
FIND_SOURCE_FILES_MAIN_C   := $(shell find $(SOURCE_FOLDER_MAIN)   -type f -name '*.c')
...
FIND_SOURCE_FILES_MAIN_COBOL   := $(shell find $(SOURCE_FOLDER_MAIN)   -type f -name '*.cbl')
...
FIND_OBJECT_FILES_MAIN_C   := $(patsubst $(SOURCE_FOLDER_MAIN)/%.c,  $(OBJECT_FOLDER_MAIN)/%.c.o,    $(FIND_SOURCE_FILES_MAIN_C))
...
FIND_OBJECT_FILES_UTILS_COBOL  := $(patsubst $(SOURCE_FOLDER_MAIN)/%.cbl,  $(OBJECT_FOLDER_MAIN)/%.cbl.o,    $(FIND_SOURCE_FILES_MAIN_COBOL))
